...
import org.hua.social.wechat.common.WechatAccessGrant;
...
public class WechatOAuth2Template implements OAuth2Operations {
	...
	public WechatOAuth2Template(String clientId, String clientSecret, String authorizeUrl, String authenticateUrl, String accessTokenUrl) {
		Assert.notNull(clientId, "The appid property cannot be null");
		Assert.notNull(clientSecret, "The secret property cannot be null");
		...
		String clientInfo = "?appid=" + clientId;
	...
	public WechatAccessGrant exchangeForAccess(String authorizationCode, String redirectUri, MultiValueMap<String, String> additionalParameters) {
	...
	public WechatAccessGrant exchangeCredentialsForAccess(String username, String password, MultiValueMap<String, String> additionalParameters) {
		MultiValueMap<String, String> params = new LinkedMultiValueMap<String, String>();
		if (useParametersForClientAuthentication) {
			params.set("appid", clientId);
			params.set("secret", clientSecret);
	...
	@Deprecated
	public WechatAccessGrant refreshAccess(String refreshToken, String scope, MultiValueMap<String, String> additionalParameters) {
		additionalParameters.set("scope", scope);
		return refreshAccess(refreshToken, additionalParameters);
	}
	
	public WechatAccessGrant refreshAccess(String refreshToken, MultiValueMap<String, String> additionalParameters) {
		MultiValueMap<String, String> params = new LinkedMultiValueMap<String, String>();
		if (useParametersForClientAuthentication) {
			params.set("appid", clientId);
			params.set("secret", clientSecret);
	...
	public WechatAccessGrant authenticateClient() {
		return authenticateClient(null);
	}
	
	public WechatAccessGrant authenticateClient(String scope) {
		MultiValueMap<String, String> params = new LinkedMultiValueMap<String, String>();
		if (useParametersForClientAuthentication) {
			params.set("appid", clientId);
			params.set("secret", clientSecret);
...
//			interceptors.add(new PreemptiveBasicAuthClientHttpRequestInterceptor(clientId, clientSecret));
	...
	protected WechatAccessGrant postForAccessGrant(String accessTokenUrl, MultiValueMap<String, String> parameters) {
	 ...
	 */
	protected WechatAccessGrant createAccessGrant(String openid, String accessToken, String scope, String refreshToken, Long expiresIn, Map<String, Object> response) {
		return new WechatAccessGrant(openid, accessToken, scope, refreshToken, expiresIn);
	}
	...
	private WechatAccessGrant extractAccessGrant(Map<String, Object> result) {
		return createAccessGrant((String) result.get("openid"), (String) result.get("access_token"), (String) result.get("scope"), (String) result.get("refresh_token"), getIntegerValue(result, "expires_in"), result);
	}
